...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('zh-Hant', 'en');
  ...
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('zh-Hant', 'en');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('zh-Hant', 'en');
  ...
  CREATE TABLE "posts" (
  	...
  	"anonymization_confirmed" boolean DEFAULT false,
  	"published_at" timestamp(3) with time zone,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_anonymization_confirmed" boolean DEFAULT false,
  	"version_published_at" timestamp(3) with time zone,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"author_name" varchar DEFAULT '作者姓名' NOT NULL,
  ...
  CREATE TABLE "site_settings_locales" (
  	"site_name" varchar DEFAULT '法律筆記' NOT NULL,
  	"tagline" varchar DEFAULT '律師的實務筆記與法律觀察' NOT NULL,
  	"homepage_hero_title" varchar,
  	"author_bio" varchar DEFAULT '分享家事民事、公司商務與法律實務經驗。' NOT NULL,
  	"author_expertise" varchar DEFAULT '家事民事、公司商務',
  	"default_description" varchar DEFAULT '以清楚易讀的方式分享法律知識、匿名化實務經驗與制度觀察。' NOT NULL,
  	"disclaimer" varchar DEFAULT '本文為一般性法律資訊與經驗分享，不構成個案法律意見或委任關係。' NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  );
  ...
  ALTER TABLE "site_settings" ADD CONSTRAINT "site_settings_author_photo_id_media_id_fk" FOREIGN KEY ("author_photo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "site_settings_author_photo_idx" ON "site_settings" USING btree ("author_photo_id");
